public class PilhaCaboDeGuerra implements Cabo {
	...
	public PilhaCaboDeGuerra(int tamanho) {
		ponteiroTopo1 = -1;
		ponteiroTopo2 = tamanho;
		dados = new Object[tamanho];
	}
	
	public PilhaCaboDeGuerra() {
		this(10);
	}
    ...
    public int getPonteiroTopo1() {
        return ponteiroTopo1;
    }

    public int getPonteiroTopo2() {
        return ponteiroTopo2;
    }
